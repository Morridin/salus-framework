...
//! This module resembles the centrepiece of the resizing capabilities of [`Panel`][frontend::components::Panel]s and
//! [`PanelGroup`][frontend::components::PanelGroup]s in the front-end.
//!
...
//!   resizable children of a [`PanelGroup`][frontend::components::PanelGroup] via a [`Signal`][dioxus::prelude::Signal].
...
//!   the user drags along a [`Panel`][frontend::components::Panel] edge to resize it. Ensures that no resizing operation
//!   violates the minimum size any [`Panel`][frontend::components::Panel] defines.
//!
//! The [`Variant`] enum is a preview for the planned [`Panel`][frontend::components::Panel] splitting feature that is already
...
//! based on the [`Panel`][frontend::components::Panel] component. Hence, this module relies heavily on Dioxus structures.
mod group_context;
